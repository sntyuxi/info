...
ui.layout(
    <drawer id="drawer">
        <vertical>
            <appbar>
                <toolbar id="toolbar" bg="#ff4fb3ff" title="GitHub 小謝同學info_學習助手"/>
                        ...
                        <vertical gravity="center" layout_weight="1">
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
                                    ...
                                    <spinner id="script_chosen" marginLeft="4" marginRight="6" entries="天天向上Pro" />  //设置为天天向上pro不可修改 "天天向上Pro|天天向上|Study改"
                                </horizontal>
                            </card>
                            <card w="*" h="70" margin="10 5" cardCornerRadius="2dp" cardElevation="1dp" foreground="?selectableItemBackground">
                                <horizontal gravity="center_vertical">
...
function getScript(choice) {
    let url_prefix = [
        ...
        'https://raw.iqiq.io/sntyuxi/info/main/',                                                      //Github iqiq.io 代理 main/ui2023.0.JS--->tiku.info.json
